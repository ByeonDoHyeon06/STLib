...
class StlibRuntimeSnapshotAssemblerTest {
    @Test
    fun `when snapshots are provided, assembles command runtime snapshot`() {
        ...
        assertEquals(StlibPluginStatus(name = "Alpha", version = "1.0.0", status = "enabled"), runtime.plugins[0])
        assertEquals(StlibPluginStatus(name = "Beta", version = "2.3.4", status = "disabled"), runtime.plugins[1])
    }
